 ...
 **************************************************************************
 **/
#define BOARD_SPI_COUNT 2 // 1 //4 //3 //1 //2 //1 //3 //1 //2 //1 //x //ETH_COUNT
...
//	// Modify the following code to use a loop for GPIO configuration based on BOARD_SPI_COUNT
//	/* spi1 sck pin */
...
//.			line7_proc();
	...
	{ // get_eth_interfaces()
		if (exint_scfg_exister())
		{																								//[To be enum , e.g. intr_pack[i], if multi-cards]
