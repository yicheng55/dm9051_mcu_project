 ...
 **************************************************************************
 */
#ifndef __AT32F4XX_CONF_2XSPI_H
#define __AT32F4XX_CONF_2XSPI_H
...
DM9051_Options dm9051optsex[BOARD_SPI_COUNT] = {
		{
				MBNDRY_WORD,
				CS_LONG,
				"CS_LONG_MODE",
...
//[common.macro]
//
// 'pin_code' always 0. when ETHERNET_COUNT==1, but BOARD_SPI_COUNT > 1.
//
int pin_code = 0;
...
// // SPI_TypeDef* SPIx;  SPI_TypeDef structure defined in at32f4xx_spi.h
// // spi_init_type spi_init_struct;  spi_init_type structure defined in at32f4xx_spi.h
// // typtedef struct  SPI_TypeDef
...
// SPI_Config spi_configs[BOARD_SPI_COUNT] = {
//   {
//     SPI1,
//     {
...
//     SPI_I2S_RDBF_INT
//   },
//   // Add more SPI configurations here as needed
// };
...
// //   {
// //     spi_default_para_init(&spi_configs[i].spi_init_struct);
// //     spi_init(spi_configs[i].SPIx, &spi_configs[i].spi_init_struct);
